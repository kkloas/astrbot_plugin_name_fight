import { expandedArts } from './expandedArts.js';
const p = (style, theme, variation = 0, anticipation = 680, amplitude = 1) => ({ style, theme, variation, anticipation, amplitude });
...
const expandedThemes = { spear: 'gold', tokens: 'vermilion', heavy_sword: 'ink', unarmed: 'mist', whip: 'silver' };
const expandedStyles = { dive: 'leap', crush: 'cleave', blink: 'draw', punch: 'palm', lash: 'sweep', bind: 'coil' };
for (const [id, art] of Object.entries(expandedArts)) {
    moveProfiles[id] = Object.fromEntries(art.moves.map((move, i) =>
        [move.name, p(expandedStyles[move.style] || move.style, expandedThemes[art.weapon], i % 3, 680, move.power)]));
}
export const themeColors = { snow: '#90cfe5', petal: '#aaa9bb', cloud: '#91a8ac', gold: '#b29a52', leaf: '#73835a', wind: '#90afb0', ink: '#344840', vermilion: '#a64c44', jade: '#568b85', silver: '#94b5c7', mist: '#819ba9', sound: '#66a9b6' };
